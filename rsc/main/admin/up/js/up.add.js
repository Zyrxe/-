const KueDB = {
            ...
            loadDataFromJSON: function() {
                fetch('rsc/main/admin/up/js/json/judul.json')
                ...
                this.defaultData.forEach((category, categoryIndex) => {
                    ...
                    category.items.forEach((item, itemIndex) => {
                        ...
                        row.innerHTML = `
                            ...
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatHarga(item.HARGA["DUS/BALL"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatHarga(item.HARGA["1 PACK"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatHarga(item.HARGA["1 PCS"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatHarga(item.HARGA["1000 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatHarga(item.HARGA["500 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatHarga(item.HARGA["250 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatHarga(item.HARGA["100 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatHarga(item.HARGA["50 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatStok(item.STOK.GUDANG)}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${KueDB.formatStok(item.STOK.TOKO)}</td>
                            <td>
...
const PlastikDB = {
            ...
            loadDataFromJSON: function() {
                fetch('rsc/main/admin/up/js/json/judul.json/judul.json')
                    .then(response => response.json())
                    .then(data => {
                ...
                this.defaultData.forEach((category, categoryIndex) => {
                    ...
                    category.items.forEach((item, itemIndex) => {
                        ...
                        row.innerHTML = `
                            ...
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${item.KODE_TOKO}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${item.KODE_GUDANG}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatHarga(item.HARGA["DUS/BALL"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatHarga(item.HARGA["1 PACK"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatHarga(item.HARGA["1 PCS"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatHarga(item.HARGA["1000 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatHarga(item.HARGA["500 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatHarga(item.HARGA["250 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatHarga(item.HARGA["100 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatHarga(item.HARGA["50 GRAM"])}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatStok(item.STOK.GUDANG)}</td>
                            <td contenteditable="true" data-category="${categoryIndex}" data-item="${itemIndex}">${PlastikDB.formatStok(item.STOK.TOKO)}</td>
                            <td>
                                <input type="date" class="date-input" value="${item.TANGGAL.MASUK || today}" 
